...
const inspectorLoader = (): void => {
    ...
    const GROUP_MAP = {
        ...
        SAFE_AREA : INSPECTOR_SAFE_AREA_CONTROL_GROUP,
        CAMERA : INSPECTOR_CAMERA_CONTROL_GROUP
    };
    ...
    const controlList: IInspectorControlOption[] = [
        ...
        {
            control: INPSECTOR_SPRITE_SLOT_CONTROL, 
            groupType: "SPRITE" 
        },
        {
        ...
        {
            control: INSPECTOR_SAFE_AREA_SCALE_X_CONTROL, 
            groupType: "SAFE_AREA" 
        },
        {
            control: INSPECTOR_SAFE_AREA_TRANSLATE_X_CONTROL,   
            groupType: "SAFE_AREA" 
        },
        {
            control: INSPECTOR_CAMERA_DROPDOWN_CONTROL,   
            groupType: "CAMERA" 
        },
        {
            control: INSPECTOR_CAMERA_ZOOM,   
            groupType: "CAMERA" 
        },
            {
            control: INSPECTOR_CAMERA_HORIZONTAL_GAP_CONTROL,   
            groupType: "CAMERA" 
        },
        {
            control: INSPECTOR_SAFE_AREA_OFFSET_TOP_CONTROL,   
            groupType: "SAFE_AREA" 
        },
        {
            control: INSPECTOR_SAFE_AREA_OFFSET_LEFT_CONTROL,   
            groupType: "SAFE_AREA" 
        }
    ];
